...
const Home = ({ isMobile, setNavStyle, isAnchorNavFixed, setIsAnchorNavFixed }) => {
  return <>
    {
      isAnchorNavFixed ?
        null :
    ...
    <Introduction
      dataSource={IntroductionDataSource}
      isMobile={isMobile}
    />
